...
Game theory supposes that games may be finite or infinite. In a finite game, the goal is to win by the end of the game. In an infinite game, the goal is to continue playing, sustainably.<sup><a href="#JamesCarse">10</a></sup> Participants in a DAO need to know that infinite games may be played as finite games, in which case the game ends with winners and losers, just like any finite game. In a successful DAO within an organization or workplace, employees must recognize the importance of responding to negative effects so that the business remains sustainable. All participants in the DAO need the intention—and need to understand the critical importance of the intention to the survival of the DAO as well as the organization—to continue actively making efforts to work collaboratively (that is, sustainably). Activities exploring how to contribute effectively as a member of a DAO may include playing games demonstrating that cooperation is more rewarding than self interest, particularly over time.
