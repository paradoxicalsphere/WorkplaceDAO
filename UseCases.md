...
1. Following a successful annual performance review, management allocates a number of tokens to the employee only for the purpose of staking to existing pools within the ecosystem.
