...
4. While the employee cannot punish self-interested behaviour that may occur, managing allocated staking tokens facilitates the employee acting meaningfully in the interests of the ecosystem as a whole to balance self-interested behaviour. For example, the employee may respond to centralization by staking tokens to one or more different, smaller pools reflecting the values of the employee as well as the company. If the employee already stakes tokens to a pool identified as becoming too central within the ecosystem, then the employee may remove stake from the pool.

### Extensions

4a. The employee may act in coordination and collaboration with other employees, as may be needed to maintain healthy decentralization of power within the ecosystem.
